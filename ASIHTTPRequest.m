            ...
            UserAgent:(NSString*)userAgent 
{
    ...
    if(![referer isEqualToString:@""] && referer)
        [request  addRequestHeader:@"Referer" value:referer];
    [request  addRequestHeader:@"User-Agent" value:
        ![userAgent isEqualToString:@""] && userAgent ? userAgent : 
        [NSString stringWithFormat: @"%@://%@/\n",
        [[[newURL absoluteString] componentsSeparatedByString:@"://"]  objectAtIndex:0],
        [[[[[newURL absoluteString] componentsSeparatedByString:@"://"]  objectAtIndex:1]  
...
+ (void)recordBandwidthUsage
{
	...
	averageBandwidthUsedPerSecond = (totalBytes > 0) ? totalBytes/measurements : 0;
}
